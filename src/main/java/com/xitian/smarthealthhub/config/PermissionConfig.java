...
public class PermissionConfig {
    ...
    public static String[] getPublicPaths() {
        return new String[]{
            ...
            "/api/carousel-items/display",
            "/health-articles/public/**",
            "/health-articles/author/**",
            "/health-videos/public/**",
            "/health-videos/author/**",
            "/article-categories/enabled-list",
            "/article-categories/simple-list",
            "/video-categories/enabled-list",
            "/video-categories/simple-list",
            "/upload/**",
            "/files/**",
            "/api/upload/**",
            "/api/files/**",
